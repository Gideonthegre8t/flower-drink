...
function About2() {
  return (
    <section>
<img className="about2-wallpaper mobile" src={about2wallpaper} alt="wallpaper" />
      <div className="about2-container">
          ...
          <div className="about2-content-text">
            ...
            <div className="about2-paragraph">
              ...
              Lorem i psum dolor sit amet, consectetur adipiscing elit. Etiam
                ...
                between.
                Lorem i psum dolor sit amet, consectetur adipiscing elit. Etiam
                quis sagittis nisl lorem i psum dolor sit amet, consectetur adipiscing elit. Etiam
                quis sagittis nisl.   Lorem i psum dolor sit amet, consectetur adipiscing elit. Etiam
                quis sagittis nisl.
              </p>
              ...
              <p className="desktop">
                ...
                celebrate the art of cocktail crafting. From classic cocktails to innovative twists and everything in
                between, join us on a journey of taste and exploration as we
                celebrate the art of cocktail crafting. Lorem i psum dolor sit amet, consectetur adipiscing elit. Etiam
                quis sagittis nisl. Morbi mi magna, congue id diam non, eleifend
                dignissim neque. Fusce convallis ex at eros feugiat elementum.
                Ut non luctus ante. In blandit purus a eros tempus.
              </p>
          ...
          <div className="cocktail-description">
            <div className=" description-card">
              ...
              <p>
                ...
                quis sagittis nisl. Morbi mi magna, congue id diam non, eleifend
                dignissim neque. Fusce convallis ex at eros feugiat elementum.
                Ut non luctus ant. Morbi mi magna, congue id diam non, eleifend
                dignissim neque. Fusce convallis ex at eros feugiat elementum.
                Ut non luctus ant
              </p>
            </div>
        ...
        <img className="sticker mobile " src={sticker} alt="flower-drink-sticker" />
        <img className="sticker desktop-sticker  desktop" src={stickerDesktop} alt="flower-drink-sticker" />
